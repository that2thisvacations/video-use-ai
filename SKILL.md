...
- Local transcription providers resolve without API keys. Use the placeholder path by default, or Piper when the user explicitly selects it and Piper is installed.
